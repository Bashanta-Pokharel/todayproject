...
<div class="container-fluid">
    <a href="{{ route('admin.category.index') }}" class="btn btn-primary">Back to List</a>
                    <a href="{{ route('admin.attribute.edit', $record->id) }}" class="btn btn-info">Edit Category</a>
                    <a href="{{ route('admin.attribute.create') }}" class="btn btn-success">Create New Category</a> 
    <!-- Page Heading -->
